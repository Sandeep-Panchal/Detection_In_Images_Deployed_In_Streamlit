...
if selected == 'Home':
    ...
    st.write("It should be noted that detection is not done  trained data. It is done using the __*Harcascades Files*__. You can visit the harcascades GitHub [here]('https://github.com/opencv/opencv/tree/master/data/haarcascades)")
